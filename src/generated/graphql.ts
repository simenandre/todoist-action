...
export type RepoInfoFragment = { __typename?: 'Repository' } & Pick<
  Repository,
  'name'
> & {
    owner:
...
export type PullRequestInfoFragment = { __typename?: 'PullRequest' } & Pick<
  PullRequest,
  'id' | 'number' | 'title' | 'url'
> & { prState: PullRequest['state'] } & {
    repository: { __typename?: 'Repository' } & RepoInfoFragment;
  };

export type IssueInfoFragment = { __typename?: 'Issue' } & Pick<
  Issue,
  'id' | 'number' | 'title' | 'url'
...
type SearchResult_App_Fragment = { __typename: 'App' };

type SearchResult_Issue_Fragment = { __typename: 'Issue' } & IssueInfoFragment;

type SearchResult_MarketplaceListing_Fragment = {
  __typename: 'MarketplaceListing';
};

type SearchResult_Organization_Fragment = { __typename: 'Organization' };

type SearchResult_PullRequest_Fragment = {
  __typename: 'PullRequest';
} & PullRequestInfoFragment;

type SearchResult_Repository_Fragment = { __typename: 'Repository' };

type SearchResult_User_Fragment = { __typename: 'User' };

export type SearchResultFragment =
  | SearchResult_App_Fragment
  | SearchResult_Issue_Fragment
  | SearchResult_MarketplaceListing_Fragment
  | SearchResult_Organization_Fragment
  | SearchResult_PullRequest_Fragment
  | SearchResult_Repository_Fragment
  | SearchResult_User_Fragment;
...
export type SearchQuery = { __typename?: 'Query' } & {
  search: { __typename?: 'SearchResultItemConnection' } & {
    nodes?: Maybe<
      Array<
        Maybe<
          | ({ __typename?: 'App' } & SearchResult_App_Fragment)
          | ({ __typename?: 'Issue' } & SearchResult_Issue_Fragment)
          | ({
              __typename?: 'MarketplaceListing';
            } & SearchResult_MarketplaceListing_Fragment)
          | ({
          ...
          | ({ __typename?: 'PullRequest' } & SearchResult_PullRequest_Fragment)
          | ({ __typename?: 'Repository' } & SearchResult_Repository_Fragment)
          | ({ __typename?: 'User' } & SearchResult_User_Fragment)
        >
      >
    >;
  };
...
`;
export const PullRequestInfoFragmentDoc = gql`
  ...
  ${RepoInfoFragmentDoc}
`;
export const IssueInfoFragmentDoc = gql`
...
export const SearchResultFragmentDoc = gql`
  ...
  ${PullRequestInfoFragmentDoc}
  ${IssueInfoFragmentDoc}
`;
